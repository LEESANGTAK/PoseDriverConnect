...
class PoseWranglerExtension(object):
    ...
    def api(self):
        ...
        :rtype: epic_pose_wrangler.v2.main.UERBFAPI
        """
    ...
    def execute(self, context=None, **kwargs):
        ...
        :type context: epic_pose_wrangler.v2.model.context.PoseWranglerContext or None
        """
    ...
    def on_context_changed(self, new_context):
        ...
        :type new_context: epic_pose_wrangler.v2.model.context.PoseWranglerContext or None
        """
        pass
